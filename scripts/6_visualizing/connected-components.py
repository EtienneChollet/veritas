...
#
    ...
    def save_id(labeled_arr, i, affine, base_dir):
        try:
...
if __name__ == '__main__':
    ...
    path = '/autofs/cluster/octdata2/users/epc28/veritas/output/models/version_6/predictions/I46_Somatosensory_20um_averaging_new-prediction_stepsz_thresh-0.5_MASKED.nii.gz'

    segmentation_arr, segmentation_aff = ConnectedComponents.load_segmentation(path, threshold=0.5)
    ...
    for i in range(0, 10):
        ConnectedComponents.save_id(labeled_arr,
                                    i,
                                    segmentation_aff,
                                    base_dir='/autofs/cluster/octdata2/users/epc28/veritas/output/models/version_6/predictions/I46_Somatosensory_Connected-Components')
