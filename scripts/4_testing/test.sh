...
jobsubmit -A psoct -p dgx-a100 -m 100G -t 7-00:00:00 -c 16 -G 1 -o logs/test/test_version-51.log python3 /autofs/cluster/octdata2/users/epc28/veritas/scripts/4_testing/test.py;
